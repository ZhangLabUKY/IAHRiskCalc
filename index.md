...
The goal of IAHRiskCalc is to calculate study-derived clamp-based IAH
and NAH classifications from symptom and physiological response values
collected at 45 and 90 mg/dL. The classifications reflect controlled
hypoglycemic clamp responses and are not standalone clinical diagnoses.
